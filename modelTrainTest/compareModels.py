...
feature_space_dir = '/data/mstambou/proteome_landscapes/highly_abundant_genomes/DESeq2_logOdds_combinedFeatureSpaces/'
...
out_dir = '/data/mstambou/proteome_landscapes/highly_abundant_genomes/modelComparisons/'
